...
public class RoomControlService {
    ...
    public Integer setRoomControlUnit(RoomControlUnitDto roomControlUnitDto) {
        ...
        int m12 = conversionService.convert(Booleans.of(
                roomControlUnitDto.isLeadWaterHeatingBlocked(),
                roomControlUnitDto.isServiceWaterHeatingBlocked()), Byte.class);
        return dataCollector.putAddress10h08hB5h10hData(new Address10h08hB5h10hData(m8, m9, m12));
    }
